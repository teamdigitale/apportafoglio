					...
					<div class="col-12 col-lg-3 text-center">
						{#if referente.MobilePhone}
							<a class="text-success" target="_blank" href="https://wa.me/{referente.MobilePhone}"
								><svg class="icon icon-success"><use href="/svg/sprites.svg#it-whatsapp"></use></svg
								></a
							>
						{/if}
					</div>
					...
					<div class="col-12 col-lg-3 text-center">
						{#if referente.Email}
							<a class="text-primary" target="_blank" href="mailto:{referente.Email}"
								><svg class="icon icon-primary"><use href="/svg/sprites.svg#it-mail"></use></svg></a
							>
						{/if}
					</div>
					<div class="col-12 col-lg-3 text-center">
						<a class="text-primary" target="_blank" href="/api/vcard/{referente.Id}"
							><svg class="icon icon-primary"><use href="/svg/sprites.svg#it-download"></use></svg
							></a
						>
					</div>
				</div>
