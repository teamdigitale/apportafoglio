...
const loadData = async (locals, misura, pacchetto,area,regione,te) => {
    ...
    if (connstandard) {
        ...
        condition = condition + " and (outfunds__Applying_Organization__r.Account_Manager__c in ('" + locals.user.utentestandard.viewas + "') or outfunds__Applying_Organization__r.Tech_Implementation_User__c in ('" + locals.user.utentestandard.viewas + "')) ";
