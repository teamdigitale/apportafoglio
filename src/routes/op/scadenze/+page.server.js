...
export async function load({ locals }) {
    ...
    if (connection) {
        ...
        outfunds__Funding_Request__r.outfunds__Applying_Organization__r.Account_Manager__c,
        outfunds__Funding_Request__r.outfunds__Applying_Organization__r.Account_Manager__r.Name,
