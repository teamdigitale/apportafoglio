...
export async function load({ locals }) {
    ...
    if (connstandard) {
        ...
        scadenze.forEach(s => {
            ...
            s.cronoprogrammi = cronoprogrammi.filter(c => c.Avviso__r.Id === s.outfunds__Funding_Request__r.outfunds__FundingProgram__r.Id
                && c.Cluster__r.Tipologia_Ente__c === s.outfunds__Funding_Request__r.outfunds__Applying_Organization__r.Tipologia_Ente__c.toUpperCase()
                && c.Cluster__r.Range__c === s.outfunds__Funding_Request__r.outfunds__Applying_Organization__r.NumericaClusterToClusterRange__c);

                //TODO verificare i multimisura
