...
export async function load({ locals }) {
    ...
    if (connstandard) {
        ...
        Stato_Progetto__c  
        from outfunds__Funding_Request__c where outfunds__Status__c = 'FINANZIATA'
        ...
        or (outfunds__FundingProgram__r.outfunds__Parent_Funding_Program__r.Name='1.1 e 1.2 Multimisura' and hasServizi11__c=false))`, MAX_FETCH);
        ...
        const all = Promise.all([candidature_1_2,qbeneficiari]);
