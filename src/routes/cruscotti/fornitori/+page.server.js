...
export async function load({ locals }) {
    ...
    if (connstandard) {
        ...
        (locals.user.utentestandard.area?
            ...
            :` and (sfdo_grants__FundingRequest__r.outfunds__Applying_Organization__r.Account_Manager__c = '` + locals.user.utentestandard.viewas + `' or sfdo_grants__FundingRequest__r.outfunds__Applying_Organization__r.Tech_Implementation_User__c = '` + locals.user.utentestandard.viewas + `')`)+
