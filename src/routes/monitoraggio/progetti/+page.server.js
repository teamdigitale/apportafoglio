...
const loadData = async (locals, misura, pacchetto,area,regione,te) => {
    ...
    if (connstandard) {
        ...
        let condition = " and outfunds__Applying_Organization__r.Stato_giuridico__c = 'Attivo' and outfunds__Applying_Organization__r.Name!='Account Marketing Cloud 1' and outfunds__Applying_Organization__r.Name!='ACCOUNTSCATOLA'  and outfunds__Applying_Organization__r.Name!='XXDTD_C2' and outfunds__Applying_Organization__r.Name!='XXDTD_C' and outfunds__Applying_Organization__r.Name!='YYACN_R' and outfunds__FundingProgram__r.outfunds__Parent_Funding_Program__r.Name != '2.2.3 Digitalizzazione delle procedure (SUAP e SUE)' ";
        if (misura !== null) {
