...
export async function load({ locals }) {
    ...
    if (connstandard) {
        ...
        const qbudgetMisura = promiseQuery(conn, "select Id, outfunds__Total_Program_Amount__c from outfunds__Funding_Program__c where outfunds__Parent_Funding_Program__C = null and Name = '1.4.1 Esperienza del cittadino nei servizi pubblici'", MAX_FETCH);

        const candidature_1_4_1 = promiseQuery(conn, `select 
        ...
        and  (outfunds__FundingProgram__r.outfunds__Parent_Funding_Program__r.Name = '1.4.1 Esperienza del cittadino nei servizi pubblici')`, MAX_FETCH);
        ...
        where 
        (outfunds__Parent_Funding_Program__r.Name = '1.4.1 Esperienza del cittadino nei servizi pubblici')
        and outfunds__Parent_Funding_Program__c != null`, MAX_FETCH);

        const all = Promise.all([candidature_1_4_1, qbeneficiari, qbudgetMisura]);
        ...
        locals.selectedMisura = '1.4.1 Esperienza del cittadino nei servizi pubblici';
        ...
        return {
            candidature: values[0].map((c) => ({
                ...
                cluster: c.outfunds__Applying_Organization__r.NumericaClusterToClusterRange__c?c.outfunds__Applying_Organization__r.NumericaClusterToClusterRange__c:'Altre scuole',
            ...
            enti: enti.map((e) => ({
                ...
                cluster: e.NumericaClusterToClusterRange__c?e.NumericaClusterToClusterRange__c:'Altre scuole'
            })),
