...
async function load({ locals, params }) {
  ...
  if (connection) {
    ...
    soggettiRealizzatori.forEach(
      (x) => {
        x.contratti = contratti.filter((y) => y.LinkedEntityId === x.Contract__c);
      }
    );
    let fornitori = Object.values(
    ...
    ).map((x) => x.Denominazione_Soggetto_Realizzatore__c).sort();
    comm.forEach((m) => {
    ...
    ch.forEach(
      (h) => {
        ...
        if (h.Field === "created") {
          h.Actor = "E";
          h.title = "La candidatura è stata creata";
          h.subtitle = "Stato della candidatura: PREBOZZA";
        } else if (h.Field === "outfunds__Status__c" && h.OldValue === "PREBOZZA") {
          h.Actor = "E";
          h.title = "La candidatura è stata salvata";
          h.subtitle = "Stato della candidatura: BOZZA";
        } else if (h.Field === "outfunds__Status__c" && h.OldValue === "BOZZA") {
          h.Actor = "E";
          h.title = "La candidatura è stata completata";
          h.subtitle = "Stato della candidatura: CONCLUSA";
        } else if (h.Field === "outfunds__Status__c" && h.OldValue === "CONCLUSA" && h.NewValue === "BOZZA") {
          h.Actor = "E";
          h.title = "La candidatura è stata riportata in lavorazione";
          h.subtitle = "Stato della candidatura: BOZZA";
        } else if (h.Field === "outfunds__Status__c" && h.OldValue === "CONCLUSA" && h.NewValue === "IN VERIFICA") {
          h.Actor = "E";
          h.title = "La candidatura è stata inviata";
          h.subtitle = "Stato della candidatura: IN VERIFICA";
        } else if (h.Field === "outfunds__Status__c" && h.OldValue === "IN VERIFICA" && h.NewValue === "AMMESSA") {
          h.type = "primary";
          h.Actor = "D";
          h.title = "La candidatura è stata ammessa";
          h.subtitle = "Stato della candidatura: AMMESSA";
        } else if (h.Field === "outfunds__Status__c" && h.OldValue === "AMMESSA" && h.NewValue === "ACCETTATA") {
          h.type = "primary";
          h.Actor = "E";
          h.title = "Il CUP è stato inserito";
          h.subtitle = "Stato della candidatura: ACCETTATA";
        } else if (h.Field === "outfunds__Status__c" && h.OldValue === "ACCETTATA" && h.NewValue === "FINANZIATA") {
          h.type = "primary";
          h.Actor = "D";
          h.title = "La candidatura è stata finanziata";
          h.subtitle = "Stato della candidatura: FINANZIATA";
        } else if (h.Field === "Stato_Progetto__c" && h.OldValue === "DA AVVIARE" && h.NewValue === "AVVIATO") {
          h.Actor = "E";
          h.title = "Il progetto è stato avviato";
          h.subtitle = "Stato del progetto: AVVIATO";
        } else if (h.Field === "Stato_Progetto__c" && h.NewValue === "DA AVVIARE") {
          h.Actor = "E";
          h.title = "Il progetto deve essere avviato";
          h.subtitle = "Stato del progetto: DA AVVIARE";
        } else if (h.Field === "Stato_Progetto__c" && h.OldValue === "AVVIATO" && h.NewValue === "IN VERIFICA") {
          h.Actor = "E";
          h.title = "Il progetto è stato completato";
          h.subtitle = "Stato del progetto: IN VERIFICA";
        } else if (h.Field === "Stato_Progetto__c" && h.OldValue === "IN VERIFICA" && h.NewValue === "AVVIATO") {
          h.Actor = "D";
          h.title = "Il progetto non ha superato la verifica";
          h.subtitle = "Stato del progetto: AVVIATO";
        } else if (h.Field === "Stato_Progetto__c" && h.OldValue === "IN VERIFICA" && h.NewValue === "IN LIQUIDAZIONE") {
          h.Actor = "E";
          h.title = "Il progetto è passato ai controlli formali";
          h.subtitle = "Stato del progetto: IN LIQUIDAZIONE";
        } else if (h.Field === "Stato_Progetto__c" && h.OldValue === "IN LIQUIDAZIONE" && h.NewValue === "LIQUIDATO") {
          h.type = "primary";
          h.Actor = "D";
          h.title = "Il progetto ha superato controlli formali";
          h.subtitle = "Stato del progetto: LIQUIDATO";
        } else if (h.Field === "Stato_Progetto__c" && h.OldValue === "IN VERIFICA" && h.NewValue === "COMPLETATO") {
          h.type = "primary";
          h.Actor = "D";
          h.title = "Il progetto ha superato la verifica";
          h.subtitle = "Stato del progetto: COMPLETATO";
        } else if (h.Field === "Stato_Progetto__c" && h.OldValue === "COMPLETATO" && h.NewValue === "IN VERIFICA") {
          h.Actor = "E";
          h.title = "Il progetto è passato in verifica";
          h.subtitle = "Stato del progetto: IN VERIFICA";
        } else if (h.Field === "Stato_Progetto__c" && h.NewValue === "RINUNCIATO") {
          h.type = "danger";
          h.Actor = "E";
          h.title = "Il progetto è stato rinunciato";
          h.subtitle = "Stato del progetto: RINUNCIATO";
        } else if (h.Field === "outfunds__Status__c" && h.NewValue === "RINUNCIATA") {
          h.type = "danger";
          h.Actor = "E";
          h.title = "La candidatura è stata rinunciata";
          h.subtitle = "Stato della candidatura: RINUNCIATA";
        } else
          ;
        if (!h.icon) {
          switch (h.type) {
